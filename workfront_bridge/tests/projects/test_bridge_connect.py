...
class Test_Display_Builder(BaseBuilderTest):
    def setUp(self):
        ...
        self.builder = bridgeconnect_builder.BridgeConnectProjectBuilder(self.wf, "Test bridge connect project")
    ...
    def test_display_native(self):
        ...
        expected = {
            'wf_template_name': 'Base Project Container - Bridge Connect Channel',
            '': {
