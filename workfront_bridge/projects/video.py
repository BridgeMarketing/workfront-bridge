...
class WFProjectVideoContainer(WFBlock):
    """
    @summary: Workfront Video Project Container.
    ...
    template_name = "Base Project Container - Video Channel"
    ...
    def __init__(self, prj_name):
        super(WFProjectVideoContainer, self).__init__(self.template_name, name=prj_name)
