...
class WFSocialCreativeVideoBlock(WFBlock):
    ...
    def fb_facebook_platforms(self, v):
        ...
        self.set_parameter(self.create_video_task_name, 'FB/Instagram Facebook Platforms', v)
    ...
    def fb_instagram_platforms(self, v):
        ...
        self.set_parameter(self.create_video_task_name, 'FB/Instagram Instagram Platforms', v)
    ...
    def fb_facebook_page_id(self, v):
        ...
        self.set_parameter(self.create_video_task_name, 'FB/Instagram Facebook Page ID', v)
    ...
    def fb_instagram_account_id(self, v):
        ...
        self.set_parameter(self.create_video_task_name, 'FB/Instagram Instagram Account ID', v)
    ...
    def fb_audience_network_platforms(self, v):
        ...
        self.set_parameter(self.create_video_task_name, 'FB/Instagram Audience Network Platforms', v)
    ...
    def fb_instagram_messenger_platforms(self, v):
        ...
        self.set_parameter(self.create_video_task_name, 'FB/Instagram Messenger Platforms', v)
